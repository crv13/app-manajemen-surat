                ...
                <table class="table table-hover table-head-fixed" id="tabelSuratkeluar">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="/suratkeluar/{{$suratkeluar->id}}/show">{{$suratkeluar->filekeluar}}</a></td>
                            ...
                            <td>
                                ...
                                <a href="/suratkeluar/{{$suratkeluar->id}}/destroy" class="btn btn-danger btn-sm my-1 mr-sm-1 btn-block" onclick="return confirm('Hapus Data ?')"><i class="nav-icon fas fa-trash"></i> Hapus</a>
                                @endif
                            </td>
                        </tr>
                        @endforeach
